...
<%
 ...
 String query2="insert into purchase values('"+qty+"','"+productname+"')";
 ...
 if(res2)
 {
     out.print("<script>alert('Product Sucessfully Add!');window.location.href='customerhome.jsp';</script>");
 }
 }
 else
 {
 out.print("<script>alert('Product Unsucessfully not add!');window.location.href='customerhome.jsp';</script>");
 }
 }
