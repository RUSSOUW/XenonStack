...
<div class="row bg-danger text-light">
    <div class="col-sm-4"> Contact No:7017984133</div>    
    <div class="col-sm-4">Email Id:<a href="mailto:mrishu4@gmail.">mrishu4@gmail.com</a></div>
    <div class="col-sm-4">Follow Us:<a href="Instagram">_russouw_</div>
</div>
<div class="row">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="images/logo_1.jpg"width="40" height="40"/>
            </a>
